package repoMind.backend.services;
...
import repoMind.backend.dto.ChatMessageResponse;
import repoMind.backend.dto.ChatSessionResponse;
import repoMind.backend.dto.CreateChatSessionRequest;
import repoMind.backend.entity.ChatMessage;
import repoMind.backend.entity.ChatSession;
import repoMind.backend.entity.IndexStatus;
import repoMind.backend.entity.MessageRole;
import repoMind.backend.entity.Repository;
import repoMind.backend.exceptions.BadRequestException;
import repoMind.backend.exceptions.NotFoundException;
import repoMind.backend.repository.ChatMessageRepository;
import repoMind.backend.repository.ChatSessionRepository;
import repoMind.backend.services.ai.ChatPromptBuilder;
import repoMind.backend.services.ai.ChatStreamHandler;
import repoMind.backend.services.ai.CitationMapper;
import repoMind.backend.services.ai.CodeContextRetriever;
...
public class ChatService {
    ...
    public SseEmitter streamReply(UUID userId, UUID sessionId, String userContent) {
        ...
        // 5. Stream MistralAi response to the client (SSE)
