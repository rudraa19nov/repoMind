...
import { RepoMindIcon } from "@/components/icons/repoMind-icon";
                        ...
                        <SidebarMenuItem>
                            ...
                            >
                                ...
                                <div className="grid flex-1 text-left text-sm leading-tight">
                                    <span className="truncate font-semibold">RepoMind</span>
...
export function BrandMark({ className }: { className?: string }) {
    return (
        ...
        >
            <RepoMindIcon className="size-8 rounded-[10px]" />
            <span className="font-heading text-[1.05rem] leading-none">RepoMind</span>
        </div>
    );
}
